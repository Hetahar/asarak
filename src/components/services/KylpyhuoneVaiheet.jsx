    ...
    <div className="bg-[#F9F5F1] w-full flex flex-wrap justify-center py-10 my-10">
      ...
      <div className="max-w-[1200px] mx-auto flex flex-wrap justify-center gap-12">
        {data.slice(0, 6).map((item, index) => (
          <section
            key={index}
            className="mx-auto py-10 px-4 md:px-0 bg-[#374151] w-[340px] h-[210px] flex flex-col items-center justify-center text-center rounded-3xl border-l-8 border-[#9F9F9F] transform transition-transform duration-300 hover:scale-105 shadow-lg"
          >
