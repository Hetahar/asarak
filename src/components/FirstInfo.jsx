const FirstInfo = () => {
  return (
    <div className="align-center flex flex-col items-center justify-center px-5">
      {/* Myyntilupaus */}
      <div
        className="w-[300px] font-semibold text-[32px] leading-[48px] text-center text-black mt-4">
        Tähän joku myyntilupaus
      </div>

      {/* Asarak Oy description */}
      <div
        className="w-[396px] h-[175px] text-[18px] leading-[25px] text-center text-black my-4">
